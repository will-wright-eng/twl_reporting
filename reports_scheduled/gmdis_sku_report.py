...
def run():
    ...
    # convert str
    df["Product Details"] = df["Product Details"].astype(str)
    df["Product SKU"] = df["Product SKU"].astype(str)
    ...
    # product details
    df["product_details_bool"] = df["Product Details"].apply(lambda x: "GMDIS" in x)
